...
const Dashboard = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            const [adminResponse, subscriberResponse] = await Promise.all([
              ...
              axios.get(`${getBaseUrl()}/api/subscribe/total-subscribers`),
            ]);
    
            setData({
              ...adminResponse.data,
              totalSubscribers: subscriberResponse.data.totalSubscribers,
            });
          } catch (err) {
    ...
    return (
        <>
            ...
            <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
                <div className="flex flex-col xl:col-span-2 bg-white shadow rounded-lg">
                ...
                <div className="flex items-center p-8 bg-white shadow rounded-lg">
                    ...
                    <div>
                        <span className="block text-2xl font-bold">{data?.totalSubscribers || 'Loading...'}</span>
                        <span className="block text-gray-500">Newsletter Subscribers</span>
                    </div>
                </div>
